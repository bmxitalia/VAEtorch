...
create_latent_plot(AE_model_2lat, val_loader, "plots/MNIST/ae_mnist_2latent.png",
                      "Autoencoder latent space - MNIST validation set - 2 latent dimensions")

create_latent_plot(AE_model_10lat, val_loader, "plots/MNIST/ae_mnist_10latent.png",
                      "Autoencoder latent space - MNIST validation set - 10 latent dimensions (T-SNE)", tsne=True)

create_reconstructed_images(AE_model_2lat, val_loader, 10, "plots/MNIST/ae_mnist_reconstruction_2latent.png",
                      "Autoencoder reconstruction - MNIST validation set - 2 latent dimensions - Input images (top) "
                      "vs. reconstructed images (bottom)")

create_reconstructed_images(AE_model_10lat, val_loader, 10, "plots/MNIST/ae_mnist_reconstruction_10latent.png",
                      "Autoencoder reconstruction - MNIST validation set - 10 latent dimensions - Input images (top) "
                      "vs. reconstructed images (bottom)")

create_generated_images(AE_model_2lat, 9, "plots/MNIST/ae_mnist_generation_2latent.png",
                      "Autoencoder generation - MNIST - 2 latent dimensions")

create_generated_images(AE_model_10lat, 9, "plots/MNIST/ae_mnist_generation_10latent.png",
                      "Autoencoder generation - MNIST - 10 latent dimensions")

generate_manifold(AE_model_2lat, "plots/MNIST/ae_mnist_manifold_2latent.png",
