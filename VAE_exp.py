...
create_latent_plot(VAE_model_2lat, val_loader, "plots/MNIST/vae_mnist_2latent.png",
                      "Variational Autoencoder latent space - MNIST validation set - 2 latent dimensions")

create_latent_plot(VAE_model_10lat, val_loader, "plots/MNIST/vae_mnist_10latent.png",
                      "Variational Autoencoder latent space - MNIST validation set - 10 latent dimensions (T-SNE)", tsne=True)

create_reconstructed_images(VAE_model_2lat, val_loader, 10, "plots/MNIST/vae_mnist_reconstruction_2latent.png",
...
create_reconstructed_images(VAE_model_10lat, val_loader, 10, "plots/MNIST/vae_mnist_reconstruction_10latent.png",
                      "Variational Autoencoder reconstruction - MNIST validation set - 10 latent dimensions - Input images (top) "
                      "vs. reconstructed images (bottom)")

create_generated_images(VAE_model_2lat, 9, "plots/MNIST/vae_mnist_generation_2latent.png",
                      "Variational Autoencoder generation - MNIST - 2 latent dimensions")

create_generated_images(VAE_model_10lat, 9, "plots/MNIST/vae_mnist_generation_10latent.png",
                      "Variational Autoencoder generation - MNIST - 10 latent dimensions")

generate_manifold(VAE_model_2lat, "plots/MNIST/vae_mnist_manifold_2latent.png",
